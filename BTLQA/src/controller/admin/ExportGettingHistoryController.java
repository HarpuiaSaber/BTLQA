...
@WebServlet(urlPatterns = "/admin/insurance/getting-history-export")
public class ExportGettingHistoryController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String fileName = ughService.exportToExecl(search);
		try {
