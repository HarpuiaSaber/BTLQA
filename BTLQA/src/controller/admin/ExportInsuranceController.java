...
@WebServlet(urlPatterns = "/admin/insurance/insurance-export")
public class ExportInsuranceController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String fileName = insuranceService.exportToExecl(search);
		try {
