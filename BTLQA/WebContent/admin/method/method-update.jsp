...
<body>
	...
	<h2>Cập nhật hình thức đóng BHXH</h2>
	<div>
		<form action="<c:url value= '/admin/method/update?id=${method.id }'/>"
			method="post" id="form">
			<div class="table-add">
				<table>
					<tr>
					...
					<tr>
						...
						<th><input class="input-add" type="number" min=1 max=999
							...
							id="month" value="${method.month }" /></th>
					</tr>
				</table>
				<table>
					<tr>
						...
						<td><button class="mybutton" type="button"
								onclick="submitForm()">Cập nhật</button></td>
