...
<body>
	...
	<h2>Lịch sử đóng BHXH</h2>
	<div class="table-input">
		<form action="<c:url value='/admin/insurance/payment-history-list'/>"
			method="post" id="form">
			<table>
				<tr>
			...
			<table>
				<tr>
					<th></th>
					<th><button
							formaction="<c:url value='/admin/insurance/payment-history-export'/>"
		...
		<div style="text-align: center;">
			<div class="pagination">
				<c:forEach var="page" begin="1"
					...
					<a
						href="<c:url value='/admin/insurance/payment-history-list?page=${page }'/>"><button
